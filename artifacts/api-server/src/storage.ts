...
export class MemStorage implements IStorage {
  ...
  createStream(data: InsertStream): StreamConfig {
    ...
    const stream: StreamConfig = {
      ...
      overlayQrPosition: data.overlayQrPosition || "top-right",
      overlayQrSize: data.overlayQrSize || "medium",
      overlaySocialEnabled: data.overlaySocialEnabled ?? false,
      overlaySocialHandle: data.overlaySocialHandle || "",
      lowerThirdStyle: data.lowerThirdStyle || "none",
      lowerThirdName: data.lowerThirdName || "",
      lowerThirdTitle: data.lowerThirdTitle || "",
      lowerThirdAccentColor: data.lowerThirdAccentColor || "#e53935",
      lowerThirdAnimation: data.lowerThirdAnimation || "slide-wipe",
      tickerStyle: data.tickerStyle || "crawl",
      messageEnabled: data.messageEnabled ?? false,
      messageText: data.messageText || "",
      messageStyle: data.messageStyle || "news-classic",
      messagePosition: data.messagePosition || "center",
      subBoxEnabled: data.subBoxEnabled ?? false,
      ...
      subBoxAnimStyle: data.subBoxAnimStyle || "none",
      chatEnabled: data.chatEnabled ?? false,
      chatPosition: data.chatPosition || "bottom-right",
      chatStyle: data.chatStyle || "list",
      chatMaxMessages: data.chatMaxMessages ?? 5,
      viewerLayout: data.viewerLayout || "standard",
      viewerScreenScale: data.viewerScreenScale ?? 1.0,
      viewerScreenX: data.viewerScreenX ?? 50,
      viewerScreenY: data.viewerScreenY ?? 50,
      adEnabled: data.adEnabled ?? false,
      adStyle: data.adStyle || "sponsor-banner",
      adText: data.adText || "",
      adSubText: data.adSubText || "",
      adBgColor: data.adBgColor || "#0a0f1e",
      adAccentColor: data.adAccentColor || "#f97316",
      adPosition: data.adPosition || "bottom-center",
      adCtaLabel: data.adCtaLabel || "LEARN MORE",
      adCountdown: data.adCountdown ?? 0,
    };
